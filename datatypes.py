...
# PART 2: Store the agent's deatils using different data types

agent_number = 7 # integer
speed_rating = 9.5 # float
mission_count = 12 # integer
height_m = 1.65 # float
is_active = True # boolean

# PART 3: Print each detail along with it's data type
...
# PART 4: Typecast the numbers and the true/false value into text
...
badge_line_2 = "ID:" + agent_number_text + " MISSIONS: " + mission_count_text # CONCATENATION
...
print(badge_line_4)
print("==============================")
print("This is the finished result")